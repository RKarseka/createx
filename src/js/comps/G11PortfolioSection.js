    ...
    <section className="portfolio-section">
      <div className="container">
        <div className="portfolio-section__top">
          <h2 className="title portfolio-section__title">
            Browse our selected projects and arn more about our work
          </h2>
          <div className="slider-nav portfolio-section__slider-nav">
            <button className="btn-reset slider-nav__btn portfolio-section__prev slider-btn">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <button className="btn-reset slider-nav__btn portfolio-section__next slider-btn">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
...
export default G11portfoliosection;
